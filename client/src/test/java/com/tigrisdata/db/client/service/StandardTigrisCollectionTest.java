...
public class StandardTigrisCollectionTest {
  ...
  public void testRead() throws TigrisDBException {
    ...
    Iterator<C1> c1s = db1.getCollection(C1.class).read(() -> "read-filter", ReadFields.empty());
  ...
  public void testDelete() throws TigrisDBException {
    ...
    DeleteResponse response =
        db1.getCollection(C1.class).delete(() -> "delete-filter", new DeleteRequestOptions());
    Assert.assertNotNull(response);
  }
        ...
        db1.getCollection(C1.class)
            .update(
                ...
                UpdateFields.newBuilder()
                    .set(UpdateFields.SetFields.newBuilder().set("int_field", 456).build())
                    .build());
