...
/**
 * Applies the generation steps required for schemas of type "object". This class was leveraged from
 * 3rd party library and modified. In its original form it lacks the ability to customize.
 *
