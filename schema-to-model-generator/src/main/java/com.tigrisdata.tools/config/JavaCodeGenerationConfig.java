...
public class JavaCodeGenerationConfig {
    ...
    private JavaCodeGenerationConfig(Builder builder) {
        ...
        this.includeConstructorForRequiredTypesOnly =
                builder.includeConstructorForRequiredTypesOnly;
    ...
    public static Builder newBuilder(String javaPackageName,
    ...
    public boolean equals(Object o) {
        ...
        if (includeJSR303Annotations != config.includeJSR303Annotations)
            return false;
        ...
        if (includeTypeInformation != config.includeTypeInformation)
            return false;
        if (includeHashCodeAndEquals != config.includeHashCodeAndEquals)
            return false;
        if (includeAdditionalProperties != config.includeAdditionalProperties)
            return false;
    ...
    public static final class Builder {
        ...
        public Builder includeConstructorForRequiredTypesOnly(
            ...
            this.includeConstructorForRequiredTypesOnly =
                    includeConstructorForRequiredTypesOnly;
            return this;
        }
