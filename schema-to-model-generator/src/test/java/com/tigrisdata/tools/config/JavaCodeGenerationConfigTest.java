...
public class JavaCodeGenerationConfigTest {
    ...
    public void testDefaults() {
        JavaCodeGenerationConfig config = JavaCodeGenerationConfig.newBuilder(
                JAVA_PACKAGE,
                TEMP_DIRECTORY
        ).build();
    ...
    public void testEqualsAndHashCode() {
        JavaCodeGenerationConfig config1 = JavaCodeGenerationConfig.newBuilder(
                JAVA_PACKAGE,
                TEMP_DIRECTORY
        ).build();

        JavaCodeGenerationConfig config2 = JavaCodeGenerationConfig.newBuilder(
                JAVA_PACKAGE,
                TEMP_DIRECTORY
        ).build();
